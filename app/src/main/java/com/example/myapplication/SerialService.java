...
public class SerialService extends Service implements SerialListener {
    ...
    public SerialService() {
        Log.d("wtf", "in SerialService() constructor");
    ...
    public IBinder onBind(Intent intent) {
        Log.d("wtf", "in SerialService's onBind()");
        return binder;
    }
    ...
    public void connect(SerialSocket socket) throws IOException {
        Log.d("wtf", "in SerialService's Connect()");
        socket.connect(this);
        this.socket = socket;
        connected = true;
    }
    ...
    public void attach(SerialListener listener) {
        Log.d("wtf", "on SerialService's attach()");
    ...
    private void createNotification() {
        Log.d("wtf", "in SerialService's createNotification()");
